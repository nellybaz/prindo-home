        ...
        <>
            ...
            <style jsx>{`
                ...
                @media only screen and (max-width: 767px) {
                    ...
                    .main-banner-shape-1, .main-banner-shape-2, .main-banner-shape-3, .main-banner-shape-4, .main-banner-shape-5, .main-banner-shape-6, .main-banner-shape-7, .main-banner-shape-8 {
                        display: none;
                    }
                }
