      ...
      <div className="plans-area pt-100 pb-70">
        <div className="container">
          <div className="section-title">
            ...
            <p>You can choose to pay monthly or yearly</p>
          </div>
                ...
                <div className="row justify-content-center">
                  <div className="col-lg-4 col-md-6">
                    <div className="single-plans-table">
                      ...
                      <ul className="plans-features-list">
                        <li>
                          <i className="ri-check-line"></i> Create up to 10
                          Stores
                        </li>
                        <li>
                          <i className="ri-check-line"></i> Supports up to 10
                          Applications
                        </li>
                        <li>
                          <i className="ri-check-line"></i> 24/7 Issue
                          resolution Support
                        </li>
                        <li>
                          <i className="ri-check-line"></i> Secure BTC
                          transactions
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="single-plans-table active-box">
                      ...
                      <ul className="plans-features-list">
                        <li>
                          <i className="ri-check-line"></i> Create up to 20
                          Stores
                        </li>
                        <li>
                          <i className="ri-check-line"></i> Supports up to 20
                          Applications
                        </li>
                        <li>
                          <i className="ri-check-line"></i> 24/7 Issue
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="single-plans-table">
                      ...
                      <ul className="plans-features-list">
                        <li>
                          <i className="ri-check-line"></i> Create up to 30
                          Stores
                        </li>
                        <li>
                          <i className="ri-check-line"></i> Supports up to 30
                          Applications
                        </li>
                        <li>
                          <i className="ri-check-line"></i> 24/7 Issue
