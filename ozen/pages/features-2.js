                        ...
                        <div className="row justify-content-center">
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-features-box">
                                    ...
                                    <p>Plod is totally digital technology based creative agency ipsum dolor sit amet consectetur adipiscing elit. Scelerisque amet odio velit eu auCTAr.</p>
                                </div>
                            </div>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-features-box">
                                    ...
                                    <p>Business change dolor sit amet, consectetur adipiscing elit. Scelerisque amet odio velit eu auCTAr. Aliquet nam elit nulla eget sodales dui pulvinar.</p>
                                </div>
                            </div>
